...
STDAPI WslcGetContainerID(WslcContainer container, CHAR containerId[WSLC_CONTAINER_ID_LENGTH + 1])
try
{
    static_assert(WSLC_CONTAINER_ID_LENGTH + 1 == sizeof(WSLCContainerId), "Container ID lengths differ.");
